...
\begin{frame}{¿Por qu\'e es importante pensar el nivel de apoyo a la democracia? ¿Y qu\'e tiene que ver con la crisis?}
  ...
  \begin{itemize}
    ...
    {\tiny Soci\'ologos pol\'iticos: ``Las elecciones son la expresi\'on democr\'atica de la lucha de clases''.}\pause
    \item[$\checkmark$] A trav\'es de elecciones, votantes debieran escoger candidatos que (entre otras cosas) prometan la re-distribuci\'on del ingreso (a trav\'es de pol\'iticas fiscales y otras pol\'iticas p\'ublicas).\pause
...
Los HDLR: 
  \begin{enumerate}
  	...
  	\item podr\'ian creer (y sentirse plenamente c\'omodos) que la distribuci\'on pueda tomar lugar bajo cualquier tipo de r\'egimen pol\'itico (incluido una dictadura).
  \end{enumerate}
