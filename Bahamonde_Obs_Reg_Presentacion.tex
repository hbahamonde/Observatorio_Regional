...
\begin{frame}{Introducci\'on}
  ...
  \begin{itemize}
    ...
    \item Sin embargo, tener datos pre-crisis podr\'ia dar se\~nales de las posibles causas de la crisis.\pause
    \item En esta presentaci\'on pensaremos acerca de si los habitantes de la regi\'on (HDLR) \emph{son m\'as {\bf democr\'aticos} o m\'as {\bf autoritarios}}.
...
\begin{frame}{¿Por qu\'e es importante pensar el nivel de apoyo a la democracia? ¿Y qu\'e tiene que ver con la crisis?}
  ...
  \begin{itemize}
    \item {\bf Sociolog\'ia pol\'itica}: las democracias debieran hacer muchas cosas, entre ellas, re-distribuir el ingreso (a trav\'es de pol\'iticas fiscales y otras pol\'iticas p\'ublicas).\pause
    \item En esta presentaci\'on, veremos que los HDLR no lo ven de esta manera, posiblemente, {\bf se\~nalando un prolongado malestar pol\'itico y social}.
  \end{itemize}
\end{frame}
...
\begin{frame}{Metodolog\'ia}
  ...
  \begin{itemize}
    \item Usando los mismos datos, estim\'e un modelo log\'istico multinomial (para variables categ\'oricas sin orden). 
    \item La {\bf variable dependiente} es si el \emph{respondente} tiene una tendencia \emph{autoritaria}, \emph{democratica}, o es \emph{indiferente} al tipo de r\'egimen.
    %\item Se ocuparon t\'ecnicas de simulaci\'on estad\'istica.
    %\item Cruc\'e Esto lo cruc\'e con distintos factores.
    %\item Formula:
  \end{itemize}
...
\begin{itemize}
  ...
  \item y donde $\pmb{x}$ = 
    \begin{enumerate}
        ...
        \item aporte de partidos politicos a la regi\'on.
...
\begin{itemize}
  ...
  \item y donde $\pmb{x}$ = 
    \begin{enumerate}
        ...
        \item edad.
        \item preferencias hacia la redistribuci\'on econ\'omica.
        \item {\bf {\color{red}aporte de partidos politicos a la regi\'on}}.
        \item grupo socio-econ\'omico.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
  ...
  \item y donde $\pmb{x}$ = 
    \begin{enumerate}
        ...
        \item preferencias hacia la redistribuci\'on econ\'omica.
        \item aporte de partidos politicos a la regi\'on.
        \item {\bf {\color{red}grupo socio-econ\'omico}}.
      \end{enumerate}
\end{itemize}
...
\begin{frame}{Aporte de los Partidos a la Regi\'on}
  \begin{itemize}
    \item El {\bf bajo apoyo de los partidos} a la regi\'on est\'a  sistem\'aticamente asociado a la {\bf indiferencia} y a actitudes {\bf democr\'aticas}.
...
Los HDLR: 
  \begin{enumerate}
    \item no asocian partidos pol\'iticos con democracia.
  	\item quieren a los partidos lejos de la pol\'itica: peligro populista?
...
\begin{frame}{Conclusiones Preliminares: \underline{Panorama no es muy alentador}}

Los HDLR:
  \begin{enumerate}
    \item est\'an sufriendo una crisis estructural de representaci\'on pol\'itica.
