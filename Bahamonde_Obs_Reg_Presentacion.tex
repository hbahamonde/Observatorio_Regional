...
\begin{frame}{Aporte de los Partidos a la Regi\'on}
  \begin{itemize}
    \item El {\bf bajo apoyo de los partidos} a la regi\'on est\'a  sistem\'aticamente a la {\bf indiferencia} y a las actitudes {\bf democr\'aticas}.
...
\begin{frame}{Conclusiones Preliminares: \underline{Panorama no es alentador}}
  \begin{enumerate}
    ...
    \item Rancag\"uinos se sienten muy identificados con su regi\'on (p\'ublico), pero muy desapegados del mundo pol\'itico (p\'ublico), como es el caso de los j\'ovenes.
