...
\begin{frame}{Motivaci\'on}
  ...
  \begin{itemize}
    ...
    \item En esta presentaci\'on pensaremos sobre ciertas actitudes de los Rancag\"uinos: ¿son los Rancag\"uinos m\'as {\bf democr\'aticos} o m\'as {\bf autoritarios}?
...
\begin{frame}{Modelo Log\'istico Multinomial}
  ...
  {\color{red}pendiente: agregar formula}
