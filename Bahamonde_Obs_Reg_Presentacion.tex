...
\title{Actitudes Democr\'aticas/Autoritarias de los Rancaguinos: Sintomatolog\'ia de la Pre-crisis}
...
\begin{frame}{Motivaci\'on}
  ...
  \begin{itemize}
    ...
    \item En esta presentaci\'on pensaremos sobre ciertas actitudes de los Rancaguinos: {\bf democr\'aticos} o {\bf autoritarios}.
    \item Presentar\'e algunas asociaciones estad\'isticas que podr\'ian dar ciertas se\~nales de una sintomatolog\'ia pre-crisis
  \end{itemize}
\end{frame}


\begin{frame}{Motivaci\'on: Teor\'ia Democr\'atica}

  \begin{itemize}
    \item En teor\'ia, las democracias debieran hacer muchas cosas. Ej., distribuir el ingreso.\\
    {\tiny``Las elecciones son la expresi\'on democr\'atica de la lucha de clases''.}
    ...
    \item En esta presentaci\'on, veremos que el sistema pol\'itico ha fracasado completamente en esta labor, se\~nalando un prolongado malestar pol\'itico y social.
  \end{itemize}
\end{frame}
...
\begin{frame}{Metodolog\'ia}
  ...
  \begin{itemize}
    \item Usando los mismos datos, estim\'e un modelo log\'istico multinomial (para variables categ\'oricas sin orden). La {\bf variable dependiente} es si el \emph{respondente} tiene una tendencia \emph{autoritaria}, \emph{democratica}, o es \emph{indiferente}.
...
\begin{frame}{Variable Dependiente: ¿Qu\'e factores explican este comportamiento?}
