...
\title{Actitudes Democr\'aticas/Autoritarias de los Rancag\"uinos: Sintomatolog\'ia de la Pre-crisis}
...
\begin{frame}{Motivaci\'on}
  ...
  \begin{itemize}
    ...
    \item En esta presentaci\'on pensaremos sobre ciertas actitudes de los Rancag\"uinos: ¿son los Rancag\"uinos m\'as {\bf democr\'aticos} o {\bf autoritarios}?
...
\begin{frame}{Motivaci\'on: ¿Por qu\'e es importante pensar el nivel de apoyo a la democr\'acia? ¿Y qu\'e tiene que ver con la crisis?}
  ...
  \begin{itemize}
    ...
    \item A trav\'es de elecciones, votantes debieran escoger candidatos que (entre otras cosas), prometan la re-distirbuci\'on del ingreso (a trav\'es de pol\'iticas fiscales y otras pol\'iticas p\'ublicas).
...
La Rancag\"uinos: 
  \begin{enumerate}
  	...
  	\item no asocian partidos con democracia.
  \end{enumerate}
\end{frame}
...
\begin{frame}{Redistribuci\'on}
  \begin{itemize}
    \item De hecho, podemos confirmar que tendencias autoritarias, democr\'aticas o indiferentes, no \emph{separan} a los Rancag\"uinos, al momento de cruzar estas actitudes con preferencias hacia la redistribuci\'on de ingresos.
  \end{itemize}
...
\begin{frame}{Interpersonal}
    %\begin{minipage}{.7\linewidth}
        \centering
        \includegraphics[width=0.98\linewidth]{/Users/hectorbahamonde/RU/research/Observatorio_Regional/confianza_interpersonal.pdf}
    %\end{minipage}
\end{frame}
...
\begin{frame}{Interpersonal}
  \begin{itemize}
    \item La confianza est\'a m\'as relacionada a actitudes democr\'aticas.
    \item La desconfianza sube la indiferencia y las actitudes no-democr\'aticas.
  \end{itemize}

  \begin{enumerate}
  	\item Aunque estos resultados van en l\'inea con lo esperable, esta asociaci\'on estad\'istica se vuelve muy nociva para la democracia.
  	\item Sobre todo porque los Rancag\"uinos no conf\'ian en las personas (70\%).
  \end{enumerate}
\end{frame}
...
\begin{frame}{Edad}
  \begin{itemize}
    \item los j\'ovenes no valoran sistem\'aticamente m\'as la democracia, y tienden a ser mas indiferentes.
  \end{itemize}
...
\section{Sociedad y Entorno}

% Conflicto

\subsection{Resultados estad\'isticos}

\begin{frame}{R\'egimen Pol\'itico y Conflicto Social}
    %\begin{minipage}{.7\linewidth}
        \centering
        \includegraphics[width=0.98\linewidth]{/Users/hectorbahamonde/RU/research/Observatorio_Regional/conflicto.pdf}
    %\end{minipage}
\end{frame}
...
\begin{frame}{R\'egimen Pol\'itico y Conflicto Social}
  \begin{itemize}
    \item Predisposici\'on al conflicto no te hace ser ni m\'as autoritario ni m\'as democr\'atico.
  \end{itemize}


La Rancag\"uinos: 
  \begin{enumerate}
  	\item no asocian el conflicto social con alg\'un r\'egimen en particular:  conflicto/paz pueden darse en cualquier r\'egimen.
  \end{enumerate}
 
 	\begin{enumerate}
  		\item Creemos que esto se\~nalar\'ia que los Rancag\"uinos no ven al sistema democr\'atico como un encausador v\'alido para la gesti\'on del conflicto social.
	\end{enumerate}
...
\begin{frame}{Propensi\'on a cambiarse de Regi\'on}
    %\begin{minipage}{.7\linewidth}
        \centering
        \includegraphics[width=0.98\linewidth]{/Users/hectorbahamonde/RU/research/Observatorio_Regional/cambiarse.pdf}
    %\end{minipage}
\end{frame}
...
\begin{frame}{Propensi\'on a cambiarse de Regi\'on}
  \begin{itemize}
    \item  No hay diferencias.
  \end{itemize}


La Rancag\"uinos: 
  \begin{enumerate}
  	\item sienten un arraigo importante con su regi\'on, y est\'an dispuestos a vivir bajo cualquier r\'egimen (pero en su regi\'on).
  \end{enumerate}

  \begin{enumerate}
  	\item Esto quiz\'as se\~nale que los Rancag\"uinos tiendan a permanecer en la regi\'on ante adversidades pol\'iticas y sociales.
  \end{enumerate}
...
\begin{frame}{Conclusiones Preliminares: \underline{Panorama no es alentador}}
  \begin{enumerate}
    \item Rancag\"uinos est\'an sufriendo una crisis estructural grave de representaci\'on pol\'itica.
    \item Rancag\"uinos no ven en la democracia un catalizador v\'alido de demandas sociales, pol\'iticas y econ\'omicas.
    \item Rancag\"uinos se sienten muy identificados con su region (p\'ublico), pero muy desapegados del mundo pol\'itico (p\'ublico), como es el caso de los j\'ovenes.
    \item Rancag\"uinos no creen que el sistema de partidos actual pueda liderar el proceso de reconfiguraci\'on socio-econ\'omica.
\end{enumerate}
